...
extern  "C" {
    ...
    /**
     * hdfsDataNodeInfo - Information about a datanode.
     */
    typedef struct  hdfsDataNodeInfo_s {
        long capacity;        /* The raw capacity */
        long dfsUsed;         /* The used space by the data node*/
        char *hostName;       /* HostName as supplied by the datanode during registration as its name*/
    ...
    /**
    * the enum declaring the datanode status 
    */
    ...
    * hdfsGetDatanodeInfo 
    *
    * The function needs superuser privileges to be executed.
    * 
    * @param fs The configured filesystem handle
    * @param one of the enum dataNodeType value
    * @param numEntries Set to the number of datanotes retrieved
    * @return an array of hdfsDataNodeInfo pointers
    */
    hdfsDataNodeInfo **hdfsGetDataNodeInfo(hdfsFS fs, enum dataNodeReportType type,int* numEntries);

    /**
    * hdfsFreeDataNodeInfo - Free up the hdfsDataNodeInfo array (including fields)
    * @param hdfsDataNodeInfos The array of dynamically-allocated hdfsDataNodeInfos pointers
    * 
    * @param numEntries The size of the array.
    */
